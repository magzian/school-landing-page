    ...
    <section class="program-section">
		...
		<div class="auto-container">
			...
			<div class="sec-title-two centered">
				...
				<h2>We have a variety of classes <br> Three Dedicated Classes</h2>
			</div>
			<!-- End Sec Title Two -->
            ...
            <div class="inner-container">
				...
				<div class="row clearfix">
					...
					<div class="program-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="icon"><img src= "{{asset('assets/images2/icons/program-1.png') }} " alt="" /></div>
							<h4><a href="course-detail.html">Toddler (1,5 – 2 years)</a></h4>
					...
					<div class="program-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="icon"><img src="{{asset('assets/images2/icons/program-2.png')}} " alt="" /></div>
							<h4><a href="course-detail.html">Preschool (2 – 3 years)</a></h4>
							<div class="text">By creating a safe, consistent and welcoming environment, we help</div>
							<div class="image">
								<div class="post-time">2.5 hours</div>
								<a href="course-detail.html"><img src="{{asset('assets/images/home-images/program-1.jpg')}} " alt="" /></a>
					...
					<div class="program-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="icon"><img src="{{asset('assets/images2/icons/program-3.png')}} " alt="" /></div>
							<h4><a href="course-detail.html">Kindergarten (3 – 4 years)</a></h4>
    ...
    <section class="mission-section">
		...
		<div class="auto-container">
            <div class="row clearfix">
				...
				<div class="content-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						<h2>Our mission for early learning & development</h2>
						<div class="bold-text">Our aim at Kids Inc Day Nurseries is to make the early years of your child’s life as enjoyable rewarding and positive as possible.</div>
						<div class="text">Nec elementum ipsum convall. Aliquam erat volutpat In id fermentum augue, ut pellentesque leo cus leo a dolor </div>
						<!-- Button Box -->
						<div class="button-box">
							<a class="theme-btn btn-style-ten" href="about.html"><span class="txt">Explore More<i class="icon"></i></span></a>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					...
					<div class="event-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
							<ul class="post-meta">
								<li><span class="icon flaticon-map"></span>School</li>
								<li><span class="icon flaticon-timetable"></span>January 1, 2022</li>
							</ul>
		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="title-column col-lg-5 col-md-12 col-sm-12">
					<div class="inner-column">
						<h2>Kindergarten Feature</h2>
						<div class="text">Our philosophy is learning through play as we offer a stimulating environment for children.</div>
						<!-- Button Box -->
						<div class="button-box">
							<a class="theme-btn btn-style-eleven" href="about.html"><span class="txt">Explore More<i class="icon"></i></span></a>
						</div>
					</div>
				</div>
					...
					<div class="inner-column">
						...
						<div class="row clearfix">
							...
							<div class="feature-block-five col-lg-6 col-md-6 col-sm-12">
								<div class="inner-box">
									<a href="blog-detail.html" class="overlay-box"></a>
					...
					<div class="testimonial-block-four">
						<div class="inner-box" style="background-image: url('{{ asset('assets/images2/background/pattern-21.png') }}')"></div>
							<div class="author-image">
								...
								<div class="image">
									<img src="{{asset('assets/images2/resource/author-4.jpg')}} " alt="" />
								</div>
							</div>
							<h4>Tamim Momo</h4>
							<div class="designation">English Teacher</div>
							<div class="text">Ahead legitimate archly lizard forceful this some gurgled thus mercifully thus some guinea bandicoot favorably.</div>
						</div>
					</div>
					...
					<div class="testimonial-block-four">
						<div class="inner-box" style="background-image: url('{{ asset('assets/images2/background/pattern-21.png') }}')"></div>
							<div class="author-image">
								<span class="quote-icon flaticon-quote-2"></span>
								<div class="image">
									<img src="{{asset('assets/images2/resource/author-5.jpg')}} " alt="" />
								</div>
							</div>
							<h4>Tamim Momo</h4>
							<div class="designation">Mahfuz Riad</div>
							<div class="text">Ahead legitimate archly lizard forceful this some gurgled thus mercifully thus some guinea bandicoot favorably.</div>
						</div>
					</div>
					...
					<div class="testimonial-block-four">
						<div class="inner-box" style="background-image: url('{{ asset('assets/images2/background/pattern-21.png') }}');"></div>
							<div class="author-image">
								<span class="quote-icon flaticon-quote-2"></span>
								<div class="image">
									<img src="{{asset('assets/images2/resource/author-6.jpg')}} " alt="" />
								</div>
							</div>
							<h4>Muhibbur Rashid </h4>
							<div class="designation">Consulting business</div>
							<div class="text">Ahead legitimate archly lizard forceful this some gurgled thus mercifully thus some guinea bandicoot favorably.</div>
						</div>
					</div>
    ...
    <footer class="footer-style-three">
		...
		<div class="auto-container">
				...
				<div class="upper-box">
					<div class="row clearfix">
						...
						<div class="title-column col-lg-8 col-md-12 col-sm-12">
							<div class="inner-column">
								<h2>Apply for Admission Call to Action</h2>
								<div class="text">Start today and get certified in Fundamentals of digital School</div>
							</div>
						</div>
						<!-- Button Column -->
						<div class="button-column col-lg-4 col-md-12 col-sm-12">
							<div class="inner-column">
								<!-- Button Box -->
								<div class="button-box">
									<a class="theme-btn btn-style-twelve" href="contact.html">Admission on<span class="icon"></span></a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row clearfix">
                            ...
                            <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                                <div class="footer-widget logo-widget">
									...
									<!-- Social Box -->
									<ul class="social-box">
										<li class="youtube"><a target="_blank" href="http://pinterest.com/" class="fa fa-youtube-play"></a></li>
                            ...
                            <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                                <div class="footer-widget contact-widget">
									...
									<ul class="contact-list">
										<li>20 Manchester Square <br> London S 360 B12​</li>
										<li>Email us<a href="#">Lebarihelp@gmail.com</a></li>
										<li>Call us<a href="#">+016826481101</a></li>
									</ul>
								</div>
							</div>
			...
			<div class="footer-bottom">
				<div class="copyright">Copyright Lebari 2022, All Right Reserved</div>
			</div>
