...
<head>
<meta charset="utf-8">
<title>LeBari Education HTML-5 Template | Event Detail</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <section class="event-detail-banner-section">
		...
		<div class="auto-container">
			...
			<div class="content-box">
				<div class="title">Online Seminar</div>
				<h2>International Acts of Kindness Day</h2>
					...
					<div class="row clearfix">
						...
						<div class="column col-lg-4 col-md-4 col-sm-12">
							...
							<ul class="course-info">
								<li><span class="icon flaticon-maps-and-flags"></span>1156, High Street, Santa Cruz, CA 9506</li>
								<li><span class="icon flaticon-user"></span>200 seat</li>
							</ul>
						</div>
						<!-- Column -->
						<div class="column col-lg-4 col-md-4 col-sm-12">
							...
							<ul class="course-info">
								<li><span class="icon flaticon-call-1"></span>0168264800101</li>
								<li><span class="icon flaticon-email-2"></span>lebari@gmail.com</li>
								<li><span class="icon flaticon-language"></span>Topic English</li>
							</ul>
						</div>
						<!-- Column -->
						<div class="column col-lg-4 col-md-4 col-sm-12">
							<h6>Date & Time:</h6>
							<ul class="course-info">
								<li><span class="icon flaticon-timetable"></span>November 23, 2020</li>
								<li><span class="icon flaticon-wall-clock"></span>9:00 am to 7:00 pm</li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="row clearfix">
				...
				<div class="content-column col-lg-8 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="learn-box">
							<h5>During this event, we’ll cover</h5>
							<ul class="learn-list">
						...
						<ul class="learn-list-two">
							...
							<li>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly </li>
				...
				<div class="info-column col-lg-4 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="event-widget">
							...
							<div class="text">There are many variations of passages of Lorem Ipsum, but the majority have suffered.</div>
							
							<!-- Event Organizer -->
							<div class="event-organizer">
								<div class="organizer">Organizers:</div>
								<ul class="organizer-list">
									<li>
										<strong>Mr Sumon Molla</strong>
										Email : sumon@example.com
									</li>
									<li>
										<strong>Mahfuz Riad</strong>
										Email : sumon@example.com
									</li>
								</ul>
								...
								<ul class="organizer-list">
									<li>
										<strong>MD Ahad master</strong>
										Email : sumon@example.com
									</li>
									<li>
										<strong>Tamim Megh</strong>
										Email : sumon@example.com
									</li>
								</ul>
