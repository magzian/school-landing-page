...
<head>
<meta charset="utf-8">
<title>LeBari Education HTML-5 Template | Teacher</title>
<!-- Stylesheets -->
            ...
            <div class="row clearfix">
				...
				<div class="content-column col-lg-8 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<h2>Lebari <br> Our professional <br> teachers</h2>
					</div>
				</div>
			...
			<div class="inner-container">
				...
				<div class="row clearfix">
					...
					<div class="team-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="course-detail.html"><img src="images/resource/team-3.jpg" alt="" /></a>
							</div>
					...
					<div class="team-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="course-detail.html"><img src="images/resource/team-4.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h5><a href="course-detail.html">Mahfuz Riad</a></h5>
								<div class="designation">- Designer, themeforest</div>
					...
					<div class="team-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="course-detail.html"><img src="images/resource/team-5.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h5><a href="course-detail.html">Mahfuz Riad</a></h5>
								<div class="designation">- Designer, themeforest</div>
					...
					<div class="team-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="course-detail.html"><img src="images/resource/team-6.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h5><a href="course-detail.html">Tamim megh</a></h5>
								<div class="designation">- Designer, themeforest</div>
